...
1. Read the autonomous loop protocol: `.cursor/skills/autoresearch/references/autonomous-loop-protocol.md`
2. Read the results logging format: `.cursor/skills/autoresearch/references/results-logging.md`
